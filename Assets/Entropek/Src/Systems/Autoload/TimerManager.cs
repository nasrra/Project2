...
public class TimerManager : MonoBehaviour{
    ...
    static SwapbackList<Timer> activeTimers = new SwapbackList<Timer>();
    static SwapbackList<Timer> pausedTimers = new SwapbackList<Timer>();
    static SwapbackList<Timer> haltedTimers = new SwapbackList<Timer>();

    static Dictionary<int, int> activeTimersIdToListIndexMap    = new Dictionary<int, int>();
    static Dictionary<int, int> pausedTimersIdToListIndexMap    = new Dictionary<int, int>();
    static Dictionary<int, int> haltedTimersIdToListIndexMap    = new Dictionary<int, int>();
    ...
    public static bool BeginTimer(Timer timer){
    ...
    public static bool HaltTimer(Timer timer){
    ...
    public static bool PauseTimer(Timer timer){
    ...
    static void AddTimerToActiveList(Timer timer){
        AddTimerToList(activeTimers, activeTimersIdToListIndexMap, timer);
    }

    static void AddTimerToHaltedList(Timer timer){
        AddTimerToList(haltedTimers, haltedTimersIdToListIndexMap, timer);
    }

    static void AddTimerToPausedList(Timer timer){
        AddTimerToList(pausedTimers, pausedTimersIdToListIndexMap, timer);
    }

    static void AddTimerToList(SwapbackList<Timer> timerList, Dictionary<int, int> idToArrayIndexMap, Timer timerToAdd){
    ...
    static void RemoveTimerFromActiveList(Timer timer){
        RemoveTimerFromList(activeTimers, activeTimersIdToListIndexMap, timer);
    }

    static void RemoveTimerFromHaltedList(Timer timer){
        RemoveTimerFromList(haltedTimers, haltedTimersIdToListIndexMap, timer);
    }

    static void RemoveTimerFromPausedList(Timer timer){
        RemoveTimerFromList(pausedTimers, pausedTimersIdToListIndexMap, timer);
    }

    static void RemoveTimerFromList(SwapbackList<Timer> timerList, Dictionary<int, int> idToArrayIndexMap, Timer timerToRemove){
